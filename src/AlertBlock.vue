<template>
  <div class="bg-gray-700 rounded-lg w-80 h-80 flex flex-wrap flex-col relative m-3">  
    ...
    <div
      v-if="setting"
      class="bg-gray-700 rounded-lg w-full h-full flex flex-col overflow-auto"
    >
      <div class="w-3/4 h-3/4 m-auto space-y-5">
        ...
        <div class="mx-auto w-3/4" v-if="enable_month">
          <select
            name="month"
            id="month"
        ...
        <div class="mx-auto w-3/4" v-if="enable_day">
        ...
        <div v-if="enable_loop" class="mx-auto w-3/4">
        ...
        <div class="mx-auto w-3/4">
          <label for="vol">音樂檔案或台詞: </label><br />
          <input
            class="w-full"
            type="text"
            id="source"
    ...
    <div
      v-if="!setting"
      class="bg-gray-700 rounded-lg w-full h-full text-center overflow-auto p-8"
    >
